...
![](plots/demo_compare.png)

## 

![](plots/race_trend.png)
...
![](images/Rlogo.png){.absolute bottom="0" left="0" width="200" height="155"} ![](images/quarto.png){.absolute bottom="54" left="calc(50% - 100px)" width="200" height="48"} ![](images/github.png){.absolute bottom="0" right="0" width="155" height="155"}
